        ...
        var EDITOR_FORM_HTML = '' +
            ...
            tableTwoColumns(
                ...
                [
                    ...
                    rowDivider(),
                    editorFormRowText('image', 'Изображение', 'изображение на Викискладе', true),
                    editorFormRowText('wiki', 'Википедия', 'статья в русской Википедии', true),
                    editorFormRowText('wdid', 'Викиданные', 'идентификатор Викиданных', true),
                    editorFormRowText('commonscat', 'Викисклад', 'категория Викисклада', true),
